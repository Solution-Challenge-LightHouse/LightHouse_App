...
class Middle1_2_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle1_2_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle1_2_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle1_2_detail> {
  String answer = '';
