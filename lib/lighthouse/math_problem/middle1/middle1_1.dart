...
class Middle1_1 extends StatefulWidget {
  const Middle1_1({super.key});

  @override
  State<Middle1_1> createState() => _TodoListPageState();
}

class _TodoListPageState extends State<Middle1_1> {
  bool isLoding = true;
  List items = [];
  String id = '';
  @override
  ...
  Future<void> fetchTodo() async {
    ...
    const url = 'http://52.79.242.2:8080/examples/find?grade=1&category=소인수 분해';
