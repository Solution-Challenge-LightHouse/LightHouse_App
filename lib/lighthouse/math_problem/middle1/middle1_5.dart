...
class Middle1_5 extends StatefulWidget {
  ...
  @override
  State<Middle1_5> createState() => _TodoListPageState();
}

class _TodoListPageState extends State<Middle1_5> {
  bool isLoding = true;
  List items = [];
  String id = '';
  @override
  ...
  Future<void> fetchTodo() async {
    ...
    const url = 'http://52.79.242.2:8080/examples/find?grade=1&category=통계';
