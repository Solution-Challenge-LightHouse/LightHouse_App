...
class Middle1_3_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle1_3_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle1_3_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle1_3_detail> {
  String answer = '';
