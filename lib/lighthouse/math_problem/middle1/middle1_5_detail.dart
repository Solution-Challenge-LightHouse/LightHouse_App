...
class Middle1_5_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle1_5_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle1_5_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle1_5_detail> {
  String answer = '';
