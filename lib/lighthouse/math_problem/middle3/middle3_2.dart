...
class Middle3_2 extends StatefulWidget {
  const Middle3_2({super.key});

  @override
  State<Middle3_2> createState() => _TodoListPageState();
}

class _TodoListPageState extends State<Middle3_2> {
  bool isLoding = true;
  List items = [];
  String id = '';
  @override
  ...
  Future<void> fetchTodo() async {
    ...
    const url =
        'http://52.79.242.2:8080/examples/find?grade=3&category=다항식의 곱셈과 인수분해';
