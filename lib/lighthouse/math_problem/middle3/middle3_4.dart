...
class Middle3_4 extends StatefulWidget {
  const Middle3_4({super.key});

  @override
  State<Middle3_4> createState() => _TodoListPageState();
}

class _TodoListPageState extends State<Middle3_4> {
  bool isLoding = true;
  List items = [];
  String id = '';
  @override
  ...
  Future<void> fetchTodo() async {
    ...
    const url = 'http://52.79.242.2:8080/examples/find?grade=3&category=삼각비';
