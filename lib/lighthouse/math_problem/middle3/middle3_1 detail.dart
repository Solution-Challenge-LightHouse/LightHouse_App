...
class Middle3_1_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle3_1_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle3_1_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle3_1_detail> {
  String answer = '';
