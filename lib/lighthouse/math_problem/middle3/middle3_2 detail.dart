...
class Middle3_2_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle3_2_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle3_2_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle3_2_detail> {
  String answer = '';
