...
class Middle3_5_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle3_5_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle3_5_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle3_5_detail> {
  String answer = '';
