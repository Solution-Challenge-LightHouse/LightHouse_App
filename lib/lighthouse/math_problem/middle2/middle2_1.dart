...
class Middle2_1 extends StatefulWidget {
  const Middle2_1({super.key});

  @override
  State<Middle2_1> createState() => _TodoListPageState();
}

class _TodoListPageState extends State<Middle2_1> {
  bool isLoding = true;
  List items = [];
  String id = '';
  @override
  ...
  Future<void> fetchTodo() async {
    ...
    const url =
        'http://52.79.242.2:8080/examples/find?grade=2&category=유한소수,무한소수,순환소수';
