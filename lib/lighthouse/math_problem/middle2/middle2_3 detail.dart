...
class Middle2_3_detail extends StatefulWidget {
  final Map todo;
  int idid;

  Middle2_3_detail({super.key, required this.todo, required this.idid});

  @override
  State<Middle2_3_detail> createState() => _CommunityDetailPageState();
}

class _CommunityDetailPageState extends State<Middle2_3_detail> {
  String answer = '';
