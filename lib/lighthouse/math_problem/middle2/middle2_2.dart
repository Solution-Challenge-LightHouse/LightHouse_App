...
class Middle2_2 extends StatefulWidget {
  const Middle2_2({super.key});

  @override
  State<Middle2_2> createState() => _TodoListPageState();
}

class _TodoListPageState extends State<Middle2_2> {
  bool isLoding = true;
  List items = [];
  String id = '';
  @override
  ...
  Future<void> fetchTodo() async {
    ...
    const url =
        'http://52.79.242.2:8080/examples/find?grade=2&category=다항식과 다항식';
